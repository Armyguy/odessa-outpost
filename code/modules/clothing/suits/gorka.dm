...
/obj/item/clothing/head/hood/gorkahood
	name = "gorka jacket hood"
	icon_state = "gorka_jacket_hood"
	desc = "A hood from a gorka jacket, oddly cozy."
	flags_inv = HIDEEARS|BLOCKHEADHAIR
	body_parts_covered = HEAD|EARS

/obj/item/clothing/suit/gorka/toggle/gorka/tan
	name = "tan gorka jacket"
	desc = "A rugged, two-tone military style field parka for the adventurer or paramilitant in you. This time, coyote brown-on-tan."
	icon_state = "gorka_jacket_tan"
	icon_open = "gorka_jacket_open_tan"
	icon_closed = "gorka_jacket_tan"

/obj/item/clothing/head/hood/gorkahood/tan
	name = "tan gorka jacket hood"
	desc = "A hood from a gorka jacket, oddly cozy."
	icon_state = "gorka_jacket_tan_hood"

/obj/item/clothing/suit/gorka/toggle/gorka/ss
	name = "camo gorka jacket"
	desc = "A rugged, two-tone military field parka for the partizan fighter in you. Smells vaguely of cosmoline."
	icon_state = "gorka_jacket_ss"
	icon_open = "gorka_jacket_open_ss"
	icon_closed = "gorka_jacket_ss"

/obj/item/clothing/head/hood/gorkahood/ss
...
/obj/item/clothing/suit/gorka/toggle/gorka/crew_g
	...
	desc = "A vaguely military style utility jacket in a modest grey two-tone and featuring green liverly."
	icon_state = "gorka_jacket_crew_g"
	icon_open = "gorka_jacket_open_crew_g"
	icon_closed = "gorka_jacket_crew_g"

/obj/item/clothing/head/hood/gorkahood/crew_g
...
/obj/item/clothing/suit/gorka/toggle/gorka/crew_b
	...
	desc = "A vaguely military style utility jacket in a modest grey two-tone and featuring blue liverly."
	icon_state = "gorka_jacket_crew_b"
	icon_open = "gorka_jacket_open_crew_b"
	icon_closed = "gorka_jacket_crew_b"

/obj/item/clothing/head/hood/gorkahood/crew_b
...
/obj/item/clothing/head/hood/gorkahood/crew_o
...
/obj/item/clothing/suit/gorka/toggle/gorka/crew_y
	...
	desc = "A vaguely military style utility jacket in a modest grey two-tone and featuring orange liverly. Za cargonia."
	icon_state = "gorka_jacket_crew_y"
	icon_open = "gorka_jacket_open_crew_y"
	icon_closed = "gorka_jacket_crew_y"

/obj/item/clothing/head/hood/gorkahood/crew_y
...
/obj/item/clothing/suit/gorka/toggle/gorka/crew_light
	...
	desc = "A fashionable parka of vaguely militant design... or it was left in the sun too long."
...
/obj/item/clothing/suit/gorka/toggle/gorka_crew_sci
	...
	desc = "A durable, baggy grey parka sporting research and development patches. Ideal for field testing in style."
...
/obj/item/clothing/suit/gorka/toggle/crew_med
	...
	desc = "A durable, baggy grey jacket sporting EMS patches and high-visibility strips, featuring a stain resistant coating."
...
/obj/item/clothing/suit/gorka/toggle/gorka_ih/ih_med_b
	...
	desc = "A durable, baggy jacket featuring blue medical liverly, stain-resistant coating, and a light woven ballistic mesh.  It has the words \"Medical Specialist\" written on its patches."
...
/obj/item/clothing/suit/gorka/toggle/gorka_ih/ih_med_g
	...
	desc = "A durable, baggy jacket featuring green medical liverly, stain-resistant coating, and a light woven ballistic mesh.  It has the words \"Medical Specialist\" written on its patches."
